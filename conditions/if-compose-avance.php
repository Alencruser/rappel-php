...
if($animal=="Chien"||$animal=="Chat" && $vivant && $couleur== "Marron" && $yeux=="Vert"){
  echo 'Oui';
}else {
  echo 'Non';
}
...
/** remplacer le chiffre 0 par les bonnes conditions **/
if($animal=="Chat"&&$vivant&&$couleur=="Marron"&&$yeux=="Vert" || $animal=="Chat"&&$vivant&&$couleur=="Blanc"&&$yeux=="Vert"){
  echo 'Oui';
}else {
  echo 'Non';
}
...
/** remplacer le chiffre 0 par les bonnes conditions **/
if($animal=="Chien"&&vivant==false&&$couleur=="Noir"&&$yeux=="Bleus" || $animal=="Chat"&&vivant&&$couleur=="Orange"&&$yeux=="Bleus" || $animal=="Chien"&&$vivant&&$couleur=="Marron"&&$yeux=="Bleus"){
  echo 'Oui';
}else {
  echo 'Non';
}
